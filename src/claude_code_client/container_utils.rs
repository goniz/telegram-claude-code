use bollard::container::{Config, CreateContainerOptions, RemoveContainerOptions, ListContainersOptions, UploadToContainerOptions, DownloadFromContainerOptions};
...
pub async fn container_put_file(
    ...
    docker.upload_to_container(container_id, Some(upload_options), tar_data.into()).await?;
