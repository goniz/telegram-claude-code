...
#[rstest]
#[tokio::test]
async fn test_claude_code_preinstalled(#[future] test_container: (Docker, String, String)) {
    let (docker, container_id, container_name) = test_container.await;
...
#[rstest]
#[tokio::test]
async fn test_claude_availability_check(#[future] test_container: (Docker, String, String)) {
    let (docker, container_id, container_name) = test_container.await;
